		...
		<section class="container">
			...
			<aside class="sidebar">
				<div class="widget widget_categories" style="top: 0px;">
					<h3>分类</h3>
					<ul>
						<li class="cat-item cat-item-7"><a href="article.html" title="测试导航"> PHP </a> (9)
						</li>
						<li class="cat-item cat-item-6"><a href="article.html" title="测试导航"> 数据库 </a> (4)
						</li>
						<li class="cat-item cat-item-11 current-cat"><a href="article.html" title="测试导航">JS</a> (4)</li>
						<li class="cat-item cat-item-11"><a href="article.html" title="测试导航"> ThinkPHP </a> (4)</li>
						<li class="cat-item cat-item-11"><a href="article.html" title="测试导航"> 操作系统 </a> (8)</li>
						<li class="cat-item cat-item-11"><a href="article.html" title="测试导航"> 其他 </a> (9)</li>
					</ul>
				</div>
